...
public record VideoRegisterResponse(
        ...
        @Schema(description = "VC가 보증하는 범위", example = "BLOCKCHAIN_REGISTRATION", nullable = true) String vcAssuranceType,
    ...
    public static VideoRegisterResponse from(Video video, boolean alreadyRegistered,
        ...
        return new VideoRegisterResponse(
                ...
                video.getRegisteredAt(), alreadyRegistered, vcPlanId, vcIssuerDid,
                video.getVcAssuranceType(), vcOfferId
        );
    }
}
